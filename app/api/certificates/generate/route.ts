...
export async function POST(req: NextRequest) {
  ...
  // Header logos - REMOVED broken image line for build test
  if (school.logoUrl) doc.image(school.logoUrl, 50, 40, { width: 80 })
  // doc.image('/ai-academy-logo.png', 650, 40, { width: 80 }) ← Commented out
  doc.fontSize(14).text('AI Academy', 650, 40) // Text placeholder instead
